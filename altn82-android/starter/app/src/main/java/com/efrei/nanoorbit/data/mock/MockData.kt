...
/**
 * Jeu de données de référence ALTN83 et ALTN82
 */
object MockData {
    ...
    // ══════════════════════════════════════════════════════════
    // SATELLITES (3 Opérationnel, 1 En veille, 1 Désorbité)
    // ══════════════════════════════════════════════════════════
    ...
    val satellites = listOf(
        ...
        // SAT-005 Désorbité — cas de test RG-S06 / trigger T1
        // L'app doit : afficher pastille grise, désactiver interactions et bloquer toute planification de fenêtre
        Satellite(
            idSatellite = "SAT-005",
    ...
    val embarquements = listOf(
        ...
        Embarquement("SAT-001", "INS-IR-01", LocalDate.of(2022, 3, 15), EtatFonctionnement.NOMINAL),
        Embarquement(
            "SAT-002",
            "INS-CAM-01",
            LocalDate.of(2022, 3, 15),
        ...
        Embarquement("SAT-004", "INS-IR-01", LocalDate.of(2023, 6, 10), EtatFonctionnement.DEGRADE),
        Embarquement(
            "SAT-005",
            "INS-AIS-01",
            LocalDate.of(2021, 11, 20),
            EtatFonctionnement.HORS_SERVICE
        )
    )
    ...
    val missions = listOf(
        Mission(
            ...
            objectif = "Surveillance de la fonte des glaces et dynamique des banquises arctiques",
        ...
        Mission(
            ...
            objectif = "Surveillance de l'évolution du trait de côte et détection d'érosion côtière",
    ...
    // ══════════════════════════════════════════════════════════
    // FENÊTRES DE COMMUNICATION (3 Réalisées, 2 Planifiées)
    // ══════════════════════════════════════════════════════════

    val fenetresCom = listOf(
        FenetreCom(
            idFenetre = 1,
            datetimeDebut = LocalDateTime.of(2024, 1, 15, 9, 14, 0),
            dureeSecondes = 420,
            elevationMax = 82.3,
        ...
        FenetreCom(
            idFenetre = 2,
            datetimeDebut = LocalDateTime.of(2024, 1, 15, 11, 52, 0),
            dureeSecondes = 310,
            elevationMax = 67.1,
            statut = StatutFenetre.REALISEE,
            idSatellite = "SAT-002",
        ...
        FenetreCom(
            idFenetre = 3,
            datetimeDebut = LocalDateTime.of(2024, 1, 16, 8, 30, 0),
            dureeSecondes = 540,
            elevationMax = 88.9,
            statut = StatutFenetre.REALISEE,
            idSatellite = "SAT-003",
        ...
        FenetreCom(
            idFenetre = 4,
            datetimeDebut = LocalDateTime.of(2024, 1, 20, 14, 22, 0),
            dureeSecondes = 380,
            elevationMax = 71.4,
        ...
        FenetreCom(
            idFenetre = 5,
            datetimeDebut = LocalDateTime.of(2024, 1, 21, 7, 45, 0),
            dureeSecondes = 290,
            elevationMax = 59.8,
            statut = StatutFenetre.PLANIFIEE,
            idSatellite = "SAT-003",
